...
## 🚀 Quick Install (The Rules)

If you don't want to run any scripts, you can manually install the rules. Copy and paste the block below into your AI's custom instructions file (e.g., `.clinerules`, `.roomodes`, `.claudecode`, or your global agent settings):
...
- **Smart Init**: If you need to explore the project, do not run `ls -R`. Instead, run `bash scripts/init-smart-search.sh .` and read `.ai-memory/repo-map.txt`.
