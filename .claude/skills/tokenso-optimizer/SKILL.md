...
description: "Use when you want to minimize token waste, intelligently search files without overflowing the context, and refresh memory across agents using Tokenso. Provides token budget awareness, auto-map refresh, batch search, and enhanced state management."
---
